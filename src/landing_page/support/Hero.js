        ...
        <section className='conatiner-fluid' id='supportHero'>
            ...
            <div className=' row p-5 m-3'>
                <div className='col-6 p-3 '>
                    ...
                    <a href='' style={{marginLeft:"2rem"}}>Track account opening</a>
                    <a href=''style={{marginLeft:"2rem"}}>Track segment activation</a>
                    <a href=''style={{marginLeft:"2rem"}}>Intraday margins</a><br/>
